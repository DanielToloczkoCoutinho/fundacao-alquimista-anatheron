...
echo "🚀 RECRIAÇÃO COMPLETA DO PORTAL CENTRAL"
echo "========================================"

# Recriar o Portal Central do zero, garantindo que esteja completo
cat > app/central/page.js << 'PORTAL_COMPLETO'
"use client"
...
echo "✅ Portal Central recriado com sucesso!"

# Verificar se o arquivo foi criado corretamente
echo ""
echo "📏 VERIFICANDO TAMANHO DO ARQUIVO:"
wc -l app/central/page.js
...
if [ $? -eq 0 ]; then
    echo ""
    echo "🎉 SUCESSO! Build realizado sem erros."
    echo ""
    echo "🚀 FAZENDO DEPLOY FINAL..."
    npx vercel --prod --force
else
    echo ""
    echo "❌ ERRO NO BUILD. Verificando detalhes..."
