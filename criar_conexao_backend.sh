#!/bin/bash
echo "🔗 CRIANDO SISTEMA DE CONEXÃO COM BACKEND PYTHON"
echo "================================================"

cd /home/user/studio

# CRIAR PÁGINA DE CONEXÃO BACKEND
mkdir -p app/conexao-backend
cat > app/conexao-backend/page.tsx << 'CONEXAO'
...
echo "✅ Sistema de conexão backend criado!"
echo "🚀 Deploy da conexão..."
npm run build
vercel --prod --yes

echo "🔗 CONEXÃO BACKEND IMPLEMENTADA!"
echo "🌐 ACESSE: https://fundacao-alquimista-anatheron.vercel.app/conexao-backend"
