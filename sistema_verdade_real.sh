#!/bin/bash
echo "🔍 CRIANDO SISTEMA DA VERDADE REAL"
echo "=================================="

cd /home/user/studio

# 1. CRIAR PÁGINA COM DADOS REAIS DA INVESTIGAÇÃO
mkdir -p app/verdade-real
...
echo "✅ Sistema da VERDADE REAL criado!"
echo "🚀 Deploy da verdade..."
npm run build
vercel --prod --yes

echo "🔍 VERDADE REAL IMPLEMENTADA!"
