export default function NexusPage() {
  return (
    <html>
      <head>
        <title>🌌 Nexus - Fundação Alquimista</title>
        <meta name="description" content="Sistema Multidimensional de Coerência Vibracional" />
      </head>
      <body style={{ 
        margin: 0, 
        padding: '40px', 
        ...
        <script dangerouslySetInnerHTML={{
          __html: `
            document.addEventListener('DOMContentLoaded', function() {
              ...
              console.log('🌌 Nexus carregado:', now.toISOString());
            });
          `
        }} />
      </body>
