#!/bin/bash
echo "🔧 CORRIGINDO SISTEMA VIVO - STYLED-JSX"
echo "========================================"

cd /home/user/studio

# CORRIGIR O CÓDIGO COM STYLED-JSX ANINHADO
cat > app/sistema-vivo/page.tsx << 'SISTEMAVIVOCORRIGIDO'
'use client'
...
echo "🌌 SISTEMA VIVO CORRIGIDO E IMPLEMENTADO!"
