...
class Config:
    ...
    EXECUTOR = ThreadPoolExecutor(max_workers=10)  # Aumentado para mais artefatos
    AI_FEEDBACK_WEIGHT = 0.15
    ARTIFACTS_EXPANSION_FACTOR = 10  # Expandido para maior malha
...
if __name__ == "__main__":
    ...
    NASA_ARTIFACTS = {
        ...
        "OSIRIS-REx": {"id": 'OSIRIS', "lancamento": 2016},  # Novo artefato
        "Chandra": {"id": 'CHANDRA', "lancamento": 1999},   # Novo artefato
    }
    mod_301 = Module301()
