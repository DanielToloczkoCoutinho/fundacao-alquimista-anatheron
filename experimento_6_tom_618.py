...
def run_all_tests():
    ...
    theta = orch.query_phase(kappa=0.34, info_index=info_index)
...
if __name__ == "__main__":
    ...
    print("Reprodutibilidade N=50: média={res['repeat_mean']:.6f}, desvio={res['repeat_std']:.6e}")
