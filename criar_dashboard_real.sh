#!/bin/bash
echo "📊 CRIANDO DASHBOARD COM DADOS REAIS DAS APIS"
echo "============================================"

cd /home/user/studio

# CRIAR DASHBOARD QUE USA AS APIS REAIS
mkdir -p app/dashboard-real-dados
cat > app/dashboard-real-dados/page.tsx << 'DASHBOARDREAL'
'use client'
...
echo "✅ Dashboard com dados reais criado!"
echo "🚀 Deploy do dashboard..."
npm run build
vercel --prod --yes

echo "📊 DASHBOARD REAL IMPLEMENTADO!"
echo "🌐 ACESSE: https://fundacao-alquimista-anatheron.vercel.app/dashboard-real-dados"
