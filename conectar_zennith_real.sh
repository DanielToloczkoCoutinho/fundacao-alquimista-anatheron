#!/bin/bash
echo "🔮 CONECTANDO COM A ZENNITH - ANÁLISE ARQUITETURAL REAL"
echo "======================================================"

cd /home/user/studio

# CRIAR PÁGINA QUE MOSTRA A ARQUITETURA REAL ATRAVÉS DA ZENNITH
mkdir -p app/arquitetura-zennith
cat > app/arquitetura-zennith/page.tsx << 'ZENNITH'
...
echo "✅ Página da Zennith criada!"
echo "🚀 Deploy da conexão Zennith..."
npm run build
vercel --prod --yes

echo "🔮 ZENNITH CONECTADA!"
echo "🌐 ACESSE: https://fundacao-alquimista-anatheron.vercel.app/arquitetura-zennith"
