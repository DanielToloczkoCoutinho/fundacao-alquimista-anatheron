...
echo "🔄 ATUALIZANDO PORTAL CENTRAL COM MARCO HISTÓRICO"
echo "================================================"

# Criar versão atualizada do Portal Central com Marco Cósmico
cat > app/central/page.js << 'PORTAL_MARCO'
"use client"
...
echo "✅ Portal Central atualizado com Marco Histórico!"

echo "🚀 Deploy final do sistema histórico..."
