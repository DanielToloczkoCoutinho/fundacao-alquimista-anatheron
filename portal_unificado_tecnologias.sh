#!/bin/bash
echo "🌐 CRIANDO PORTAL UNIFICADO DE TECNOLOGIAS"
echo "=========================================="

cd /home/user/studio

# Atualizar o portal principal para incluir todas as novas interfaces
...
echo "✅ Portal unificado atualizado!"
echo "🚀 Deploy final..."
npm run build
vercel --prod --yes

echo "🌐 PORTAL UNIFICADO PRONTO!"
