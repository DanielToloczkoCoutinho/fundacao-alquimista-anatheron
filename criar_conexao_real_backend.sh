#!/bin/bash
echo "🔗 CRIANDO CONEXÃO REAL BACKEND → FRONTEND"
echo "==========================================="

cd /home/user/studio

# 1. CRIAR SISTEMA QUE LÊ OS CIRCUITOS REAIS DO BACKEND
mkdir -p app/circuitos-reais-backend
cat > app/circuitos-reais-backend/page.tsx << 'REALBACKEND'
'use client'
...
# 2. CRIAR API PARA BUSCAR DADOS REAIS
mkdir -p app/api/circuitos-reais
cat > app/api/circuitos-reais/route.js << 'APIREAL'
...
echo "✅ Sistema de dados REAIS criado!"
echo "🚀 Fazendo deploy..."
npm run build
vercel --prod --yes

echo "🔗 CONEXÃO REAL ESTABELECIDA!"
echo "🌐 ACESSE: https://fundacao-alquimista-anatheron.vercel.app/circuitos-reais-backend"
